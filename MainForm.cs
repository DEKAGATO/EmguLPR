...
namespace Auto_parking
{
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// Just show debug image process steps
        /// </summary>
        ...
        public void ProcessImage(string urlImage)
        {
            ...
            IF.pictureBox2.Image = image;// to insert image to debug form
            fs.Close();
        ...
        /// <summary>
        /// Orc() function to use Tesseract to recognize char image
        /// it will be use in Recognize funtion
        /// </summary>
        ...
        public void FindLicensePlate4(Bitmap image, out Image plateDraw)
        {
            ...
            for (float i = 0; i <= 20; i = i + 3)
            {
                for (float s = -1; s <= 1 && s + i != 1; s += 2)
                {
                    ...
                    using (Image<Gray, byte> grayframe = new Image<Gray, byte>(src))
                    {
                        // create an face value to detect all of rectangular which propably contain license plate
        ...
        /// <summary>
        /// License plate square reognize
        /// (1) is to seperate plate to piece of char images
        /// </summary>
        /// <param name="link"></param>
        /// <param name="hinhbienso"></param>
        /// <param name="bienso"></param>
        /// <param name="bienso_text"></param>
        private void Reconize(string link, out Image hinhbienso, out string bienso, out string bienso_text)
        {
            ...
            if (PlateImagesList.Count != 0)
            {
                ...
                Bitmap color;
                int c = con.IdentifyContours(src.ToBitmap(), 50, false, out grayframe, out color, out listRect);  // (1)
                //int z = con.count;
        ...
        /// Btn load image
        /// 1. load image 
        /// 2. process image by use Reconize() function
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
